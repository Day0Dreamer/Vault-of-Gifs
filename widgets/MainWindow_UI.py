...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layout_fileops.setSizeConstraint(QtGui.QLayout.SetNoConstraint)
        ...
        self.list_videoslist = QtGui.QListView(self.centralwidget)
        ...
        self.horizontalLayout.addWidget(self.plaintext_act_readout)
